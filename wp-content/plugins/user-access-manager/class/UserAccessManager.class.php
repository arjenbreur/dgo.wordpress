            ...
            if (version_compare($currentDbVersion, "1.1") === 0) {
                ...
                foreach ($objectTypes as $objectType) {
                    ...
                    foreach ($dbObjects as $dbObject) {
                        $sql = "REPLACE INTO ".$dbAccessGroupToObject." (
                        		group_id, 
                        		object_id,
                        		object_type
                        	) 
...
// ADD DGOFORUMTOPIC SUPPORT
            $uamAdminOptions['hide_dgoforumtopic_comment']='false';
            $uamAdminOptions['hide_dgoforumtopic']='false';
     ...
     * add_filter('DGO_pre_get_posts', array(&$userAccessManager, 'pre_get_posts'));
     * 
