<?php
/**
 * Plugin Name: DGO Transactions
 * Plugin URI: http://dgo.3r13.nl/dgotransactions
 * Description: Adds transactions to wordpress.
 * Version: 1.0
 * Author: Arjen Breur
...
DGO_transactions::init();

class DGO_transactions {
    // DEFINE CONSTANTS FOR THIS PLUGIN
    const TXT_DOMAIN 			= 'dgo_transactions';
	const CPT_NAME 				= 'dgotransaction';
	const VERBOSE_NAME_SINGULAR	= 'Transactie';
	const VERBOSE_NAME_PLURAL	= 'Transacties';
